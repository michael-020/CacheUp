...
export default function PostCard({ post, isAdmin }: PostCardProps) {
  ...
  return (
    <div
      className="xl:max-w-[700px] lg:max-w-[550px] mx-auto rounded-xl bg-white dark:bg-neutral-800 dark:border-neutral-900 dark:shadow-0 dark:shadow-sm p-4 shadow-lg mb-4 border border-gray-200"
    >
