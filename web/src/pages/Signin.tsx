                    ...
                    <form className="grid gap-4 sm:gap-5">
                        ...
                        <div className="grid gap-1 sm:gap-2">
                            ...
                            <input
                                ...
                                className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm dark:bg-gray-600/60 dark:text-gray-100 dark:placeholder:text-gray-400/40 bg-blue-50/50 border border-gray-200 dark:border-neutral-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                        ...
                        <div className="grid gap-1 sm:gap-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm bg-blue-50/50 dark:bg-gray-600/60 dark:text-gray-100 dark:placeholder:text-gray-400/40 border border-gray-200 dark:border-neutral-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
