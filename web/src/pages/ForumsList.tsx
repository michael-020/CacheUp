      ...
      <div className="max-w-6xl mx-auto p-6 translate-y-20 min-h-[calc(100vh-5.1rem)]">
        <div className="flex flex-col mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 w-fit text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-3 py-1.5 rounded-md transition-colors duration-200 mt-3 font-medium"
          >
